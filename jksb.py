...
def sign_in(id, pwd):
    ...
    form = {
        ...
        "myvs_13b": "3611",  # 地市：地级市编码 对应身份证前四位  郑州市=4101
        "myvs_13c": "江西省.上饶市.广丰区",  # 自己填写当前所在地即可
        "myvs_24": "否",
        "myvs_26": "5",  # 疫苗接种情况：0是待选；1是1针剂；2是2针剂；3是尚未接种；4是有禁忌症，无法接种；5是三针3针剂
        # "myvs_14b": "",  # 该选项已弃用
        "memo22": "江西省上饶市广丰区",  # [待定] 位置获取情况
        ...
        "fun3": "",
        # 注释掉经纬度
        # "jingdu": "118.19",  # 经度： 北校区经度,jingdu=113.658055
        # "weidu": "38.44",  # 纬度： 北校区纬度,&weidu=34.782807  东经113.658333北纬34.7822222
        "ptopid": ptopid,
        "sid": sid,
    }
    headers = {
